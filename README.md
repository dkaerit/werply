...
<div style="display: flex; border: 1px solid #fff; border-radius: 10px; padding: 20px 20px 0px 20px;">
<div><img width="25px" src="https://i.imgur.com/EYdeHbu.png"></img></div>
...
<div style=" border: 1px solid #fff; border-radius: 10px; padding: 20px 20px 0px 20px;">
