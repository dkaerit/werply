...
const syncScroll = async () => {
  let newCol1 = document.querySelector("#col1");
  let newCol2 = document.querySelector("#col2");
...
<template>
  <v-container class="pa-0">
    <v-row class="centered">
      ...
      <v-col
        id="col1"
        class="col-posts pa-0 overflow-y-auto"
        cols="md-8 12"
        @scroll="syncScroll"
      >
      ...
      <v-col
        id="col2"
        class="col-widgets d-none outline-left d-md-flex pr-4 overflow-y-auto scrollable-container"
        @scroll="syncScroll"
      >
        <v-container>
          <div class="text-disabled text-body-2 text-justify">
            Condiciones de Servicio Política de Privacidad Política de cookies
            Accesibilidad Información de anuncios Más opciones<br />
            © 2023 Werply.
          </div>
        </v-container>
      </v-col>
