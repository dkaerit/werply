 ...
 */
 const login = (): void => {
  ...
  store.dispatch(action, {"identifier": loginIdentifier.value, "passwd": password.value});
};
  ...
  <div class="box" id="login-container">
    ...
    <div class="row" id="login-form">
      ...
      <div class="buttons">
        ...
        <hr/>
        <br/>
        <form class="form" method="post" id="alternative-login" @submit.prevent="login" autocomplete="off">
